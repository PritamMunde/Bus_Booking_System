...
public class BusDetailsServiceImpl implements BusDetailsService {
	...
	public BusDetails getBusByNumber(int busNumber) throws ResourceNotFoundException {
	 ...
	 @Override
	    public void updateAvailableSeats(int busNumber, int newAvailableSeats) throws ResourceNotFoundException {
	        BusDetails busDetails = getBusByNumber(busNumber);
	        busDetails.setAvailableSeats(newAvailableSeats);
