...
public class BusDetailsController {
	...
	@PutMapping("/{busNumber}/update-seats")
    public ResponseEntity<Void> updateAvailableSeats(@PathVariable int busNumber,int newAvailableSeats) throws ResourceNotFoundException {
        busService.updateAvailableSeats(busNumber, newAvailableSeats);
